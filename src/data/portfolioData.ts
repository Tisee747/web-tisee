...
export const projectsData: Project[] = [
  // Web projects with active websites (featured on home page)
  {
    ...
    demoUrl: 'https://posyandupintar.example.com',
    repoUrl: 'https://github.com/Tisee747/posyandu-pintar',
    version: 'v1.4.0',
    status: 'Live',
    stars: 32,
    forks: 8,
  ...
  },
  {
    ...
    demoUrl: 'https://nexevent.example.com',
  ...
  },
  {
    ...
    tags: ['Fullstack'],
    technologies: ['Laravel', 'Flutter', 'PHP', 'Dart'],
    demoUrl: 'https://mydormitory.example.com',
    repoUrl: 'https://github.com/Tisee747/mydormitory',
    version: 'v1.0.8',
    status: 'Beta',
    stars: 18,
    forks: 5,
  ...
  },
  {
    ...
    demoUrl: 'https://telyutalks.example.com',
  ...
  // Other projects (available on projects page)
  {
    ...
    repoUrl: 'https://github.com/Tisee747/gpt-ner',
    version: 'v0.9.4',
    status: 'Beta',
    stars: 54,
    forks: 11,
  ...
  },
  {
    ...
    repoUrl: 'https://github.com/Tisee747/microplast',
    version: 'v1.0.2',
    status: 'Live',
    stars: 67,
    forks: 18,
  ...
  },
  {
    ...
    repoUrl: 'https://github.com/Tisee747/medusa-npc-chatbot',
    version: 'v1.2.0',
    status: 'Live',
    stars: 112,
    forks: 22,
  ...
  },
  {
    ...
    repoUrl: 'https://github.com/Tisee747/lsl-racegame',
    version: 'v1.5.0',
    status: 'Live',
    stars: 93,
    forks: 29,
